...
export const Rotate = ({ in: inProp, component, onClick }) => (
	<Transition in={inProp} timeout={duration.rotate}>
		{state => (
			<Container
				onClick={onClick}
				style={{
...
export const Remove = ({ in: inProp, component }) => (
	<Transition in={inProp} timeout={duration.remove} unmountOnExit>
		{state => (
			<Container
				style={{
					...defaultStyle.remove,
...
export const Grow = ({ in: inProp, component }) => (
	<Transition in={inProp} timeout={duration.grow} mountOnEnter unmountOnExit>
		{state => (
			<Container
				style={{
					...defaultStyle.grow,
...
export const Flip = ({ in: inProp, component, onClick }) => (
	<Transition in={inProp} timeout={duration.flip}>
		{state => (
			<Container
				onClick={onClick}
				style={{
...
export const DropIn = ({ in: inProp, component }) => (
	<Transition in={inProp} timeout={duration.dropIn}>
		{state => (
			<WideContainer
				style={{
					...defaultStyle.dropIn,
...
export const PageChange = ({ in: inProp, component }) => (
	<Transition in={inProp} timeout={duration.pageChange}>
		{state => (
			<WideContainer
				style={{
